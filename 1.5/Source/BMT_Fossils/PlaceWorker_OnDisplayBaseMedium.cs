...
{
    public class PlaceWorker_OnDisplayBaseMedium : PlaceWorker
    {
        public override AcceptanceReport AllowsPlacing(BuildableDef checkingDef, IntVec3 loc, Rot4 rot, Map map, Thing thingToIgnore = null, Thing thing = null)
        {
            Thing dispThing = map.thingGrid.ThingAt(loc, FossilsDefOf.BMT_DisplayMedium);
        ...
        {
            return otherDef == FossilsDefOf.BMT_DisplayMedium;
        }
    }
}
